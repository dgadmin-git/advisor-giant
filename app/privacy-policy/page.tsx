      ...
      <main className="min-h-screen bg-zinc-50 py-12">
        <div className="mx-auto max-w-4xl px-6">
          <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
            <p className="text-zinc-500 text-sm mb-2">Privacy Policy for the URL https://advisorgiant.com/</p>
            <h1 className="text-4xl font-bold text-[#1E3A5F] mb-4">
              PRIVACY POLICY — AdvisorGiant.com
            </h1>
            <p className="text-zinc-600 mb-1"><strong>Operated by Giant Partners, Inc., a California Corporation</strong></p>
            <p className="text-zinc-600 mb-1"><strong>Doing Business As (&quot;DBA&quot;) Advisor Giant</strong></p>
            <p className="text-zinc-500 mb-6"><strong>Last Updated:</strong> December 1, 2025</p>
            ...
            <section className="mb-10">
              ...
              <p className="text-zinc-700 mb-2"><strong>(1) Information you submit directly</strong></p>
              <p className="text-zinc-700 mb-6"><strong>(2) Information collected automatically when you visit the Site</strong></p>
              ...
              <div className="mb-4">
                ...
                <p className="text-zinc-700">Used to understand anonymous behavioral patterns such as clicks, scroll depth, and engagement.</p>
                <p className="text-zinc-700">Clarity <strong>does not</strong> capture form input fields or personal information.</p>
              </div>

              <div className="mb-4">
                <p className="font-semibold text-zinc-800">TrustedForm (ActiveProspect)</p>
                <p className="text-zinc-700">Used to certify your form submission for legal and compliance verification.</p>
                <p className="text-zinc-700">TrustedForm may collect metadata and session-level info but <strong>does not</strong> capture your personal data.</p>
                <p className="text-zinc-700">A certificate may be shared with the financial advisor who receives your lead.</p>
              </div>

              <div className="mb-4">
                <p className="font-semibold text-zinc-800">HubSpot CRM</p>
                <p className="text-zinc-700">Used solely to store lead submissions.</p>
                <p className="text-zinc-700">HubSpot tracking cookies are <strong>not enabled</strong> on this Site.</p>
              </div>

              <div className="mb-4">
                <p className="font-semibold text-zinc-800">Meta (Facebook) Pixel &amp; Hashed Data Uploads</p>
                <p className="text-zinc-700">We use the Meta Pixel for advertising measurement and optimization.</p>
                <p className="text-zinc-700">We may upload <strong>hashed</strong> email and phone numbers to create custom or lookalike audiences.</p>
              </div>
            </section>
            ...
            <section className="mb-10">
              ...
              <p className="text-zinc-700 mb-4">We do not sell your personal information to unrelated marketing companies.</p>
              <p className="text-zinc-700 mb-4">We only transfer lead data to:</p>
              <ul className="list-disc list-inside text-zinc-700 space-y-2 ml-4 mb-4">
            ...
            <section className="mb-10">
              ...
              <p className="text-zinc-700 mb-1"><strong>Giant Partners, Inc. (DBA Advisor Giant)</strong></p>
              <p className="text-zinc-700 mb-1">AND</p>
