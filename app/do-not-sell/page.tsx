    ...
    <main className="min-h-screen bg-zinc-50 py-12">
      <div className="mx-auto max-w-4xl px-6">
        <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
          ...
          <p className="text-zinc-600 mb-2">Operated by Giant Partners, Inc. (DBA Advisor Giant)</p>
          <p className="text-zinc-500 mb-8">Last Updated: December 1, 2025</p>
          ...
          <section className="mb-10">
            ...
            <p className="text-zinc-700 mb-6">
              To exercise your privacy rights and request that we stop selling or sharing your personal
              information, choose one of the options below:
            </p>
